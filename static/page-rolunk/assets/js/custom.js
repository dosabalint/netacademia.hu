...
! function(t) {
  ...
  function a(t) {
    var e, a, i = {
      ...
      o = t && t.ownerDocument;
    return e = o.documentElement, void 0 !== t.getBoundingClientRect && (i = t.getBoundingClientRect()), a = n(o), {
  ...
  function o(t) {
    ...
    for (var e = null, n = t.target || t.srcElement; null !== n.parentElement;) {
      if (!(n instanceof SVGElement || -1 === n.className.indexOf("waves"))) {
        e = n;
        break
      }
      if (n.classList.contains("waves")) {
        e = n;
        break
      }
      n = n.parentElement
  ...
  var s = s || {},
    ...
    c = {
      ...
      hide: function(t) {
        ...
        var o = (n = a[a.length - 1]).getAttribute("data-x"),
      ...
      wrapInput: function(t) {
        for (var e = 0; e < t.length; e++) {
          ...
          if ("input" === n.tagName.toLowerCase()) {
            var a = n.parentNode;
            if ("i" === a.tagName.toLowerCase() && -1 !== a.className.indexOf("waves")) continue;
            var i = document.createElement("i");
            i.className = n.className + " waves-input-wrapper";
            var o = n.getAttribute("style");
            o || (o = ""), i.setAttribute("style", o), n.className = "waves-waves-input", n.removeAttribute("style"), a.replaceChild(i, n), i.appendChild(n)
          }
        }
      }
    },
  ...
  s.displayEffect = function(e) {
    "duration" in (e = e || {}) && (c.duration = e.duration), c.wrapInput(u(".waves")), "ontouchstart" in t && document.body.addEventListener("touchstart", r, !1), document.body.addEventListener("mousedown", r, !1)
  }, s.attach = function(e) {
...
(function($) {
  ...
  function sticky() {
    ...
    $("#header-sticky #logo img").attr("src", "assets/images/logo-icon.svg");
  ...
  $(document).ready(function() {
          ...
          $(form).ajaxSubmit({
            ...
            success: function(msg) {
              ...
              if (msg == 'OK') {
                ...
                $(".form-validator-class").clearForm();
              } else {
                result = msg;
              }
    ...
    if (typeof $.fn.validate !== 'undefined') {
      ...
      $(".netacademia-business-form").validate({
        rules: {
          name: {
            required: true
          },
        ...
        submitHandler: function(form) {
          ...
          $(form).ajaxSubmit({
            ...
            success: function(msg) {
              ...
              if (msg == 'OK') {
                result = '<div class="alert alert-success">Your message was successfully sent!</div>';
                $(".netacademia-business-form").clearForm();
              } else {
                result = msg;
              }
